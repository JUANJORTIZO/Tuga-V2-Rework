        ...
        <div className="min-h-screen flex flex-col">
            ...
            <BackgroundLayout>
                <Panel maxWidth="max-w-6xl">
                    <h2 className="text-2xl md:text-3xl font-serif-title text-center mb-10">
                        Historial de Turnos
                    </h2>
                                    ...
                                    <tr key={turn.id} className="bg-white">
                                        ...
                                        <td className="border border-gray-300 px-4 py-3">
                                            <button
                                                ...
                                                className="text-blue-600 font-semibold hover:text-blue-800 transition-all duration-200 hover:underline hover:translate-x-1"
                                            >
                                                Ver caso →
                                            </button>
                                        </td>
                    ...
                    <div className="flex justify-start mt-8">
                        <OrangeButton variant="primary" onClick={() => navigate('/turnos')}>
                            Atrás
                        </OrangeButton>
                    </div>
                </Panel>
