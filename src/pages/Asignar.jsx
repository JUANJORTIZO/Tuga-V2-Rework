          ...
          <div className="flex flex-col md:flex-row items-stretch gap-10">
            ...
            <div className="flex items-stretch gap-6">
              ...
              <button
                ...
                className="w-[90px] md:w-[100px] min-h-[220px] rounded-2xl border-4 border-white bg-usb-orange text-white shadow-lg hover:scale-105 transition-transform flex flex-col items-center justify-center gap-4"
              >
